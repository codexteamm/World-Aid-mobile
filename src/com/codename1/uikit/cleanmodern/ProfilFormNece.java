 ...
 * @author DELL
 */
public class ProfilFormNece  extends BaseForm {
    ...
    public ProfilFormNece(Resources res) {
        super("Newsfeed", BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Welcome Necessiteux");
...
//            u.setRole(role.getText());
            ...
            a = UtilisateurService.getInstance().updateNece(u, x);
