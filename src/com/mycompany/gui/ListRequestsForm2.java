 ...
 * @author bhk
 */
public class ListRequestsForm2 extends Form {

    private Resources theme;
    Form current;
    

    public ListRequestsForm2(Form previous, Resources resourceObjectInstance) {
        ...
        for (demande_aide da : LRequests) {
            ...
            twoLinesNoIcon.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                    new showRequestDetailsForm2(current,da).show();
